<template>
  <section class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
    ...
    <div class="flex items-center">
      ...
      <button type="button" class="-m-2 ml-4 p-2 text-gray-400 hover:text-gray-500 sm:ml-6 lg:hidden" @click="$emit('openMobileFlyout')">
...
const { title } = defineProps(['title', 'sortOptions'])
</script>
