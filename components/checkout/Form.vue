<template>
  <section aria-labelledby="payment-heading" class="flex-auto overflow-y-auto px-4 pb-16 pt-12 sm:px-6 sm:pt-16 lg:px-8 lg:pb-24 lg:pt-0">
    ...
    <div class="mx-auto max-w-lg lg:pt-16">
      <LoftusButton type="button" class="flex !w-full items-center justify-center rounded-md border border-transparent bg-black py-2 text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2">
      ...
      <form class="mt-6">
        ...
        <LoftusButton class="mt-6 !w-full justify-center bg-primary text-white hover:bg-transparent hover:text-primary hover:border-primary">Submit Order</LoftusButton>
